...
wget -q --show-progress --https-only --timestamping \
  ...
  sudo cp /tmp/ca.pem /tmp/ca-key.pem /tmp/kubernetes-key.pem /tmp/kubernetes.pem \
...
ExecStart=/usr/local/bin/kube-apiserver \\
  ...
  --etcd-servers=https://10.120.0.10:2379,https://10.120.0.11:2379,https://10.120.0.12:2379 \\
  --event-ttl=1h \\
